    ...
    return (
      <div>
        ...
        <ul className="hoglist">
          <BabyHog eyeColor={this.state.eyeColor} hogInfo={offspring[0]}/>
          <BabyHog eyeColor={this.state.eyeColor} hogInfo={offspring[1]}/>
          <BabyHog eyeColor={this.state.eyeColor} hogInfo={offspring[2]}/>
        </ul>
